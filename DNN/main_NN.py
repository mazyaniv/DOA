...
#
#         my_train(data_train, labels_train, my_model, num_epochs=train_prameters.epoch, batch_size=train_prameters.batch, file_path=file_path,checkpoint_bool=True)
#
#
#
#
